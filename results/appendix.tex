...
\end{tabular}}%
\vspace{0.3em}
\par\noindent{\small \emph{Passes}: per-question inference cost. SECL uses 1~FWD at inference (adapted model); amortized cost over the stream is 1.8--4.6~FWD-eq per question (see Section~\ref{app:cost}).}
